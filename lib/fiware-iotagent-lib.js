...
function doActivate(newConfig, callback) {
    ...
    if (newConfig.deviceRegistry &&
        ...
        if (newConfig.isWebService){
            registry = require('./services/webservices/webServiceRegistryMongoDB');
        } else {
        ...
        if (newConfig.isWebService){
            registry = require('./services/webservices/webServiceRegistryMemory');
        } else {
...
exports.setWebServiceProvisioningHandler = contextServer.setWebServiceProvisioningHandler;
...
exports.addWebServiceProvisionMiddleware = contextServer.addWebServiceProvisionMiddleware;
...
exports.parser = require('./plugins/expressionParser');
...
exports.dataPlugins = {
    ...
    webserviceProcess: require('./plugins/webserviceProcessPlugin')
};
