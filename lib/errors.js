...
module.exports = {
    ...
    WebServiceNotFound: function(id) {
        this.name = 'WEB_SERVICE_NOT_FOUND';
        this.message = 'No web service was found with id:' + id;
        this.code = 404;
    },
    DuplicateWebServiceId: function(id) {
        this.name = 'DUPLICATE_WEB_SERVICE_ID';
        this.message = 'A web service with the same id was found:' + id;
        this.code = 409;
    },
};
