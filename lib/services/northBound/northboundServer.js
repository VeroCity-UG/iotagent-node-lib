...
var northboundServer;
var contextServer = require('./contextServer');
var domainUtils = require('../common/domain');
var middlewares = require('../common/genericMiddleware');
var intoTrans = domainUtils.intoTrans;
var deviceProvisioning = require('./deviceProvisioningServer');
var groupProvisioning = require('./deviceGroupAdministrationServer');
var webServiceProvisioning = require('./webServiceProvisioningServer');
...
function start(config, callback) {
    ...
    if (config.isWebService){
        webServiceProvisioning.loadContextRoutes(northboundServer.router);
    } else {
...
exports.setWebServiceProvisioningHandler = intoTrans(context, webServiceProvisioning.setProvisioningHandler);
...
exports.addWebServiceProvisionMiddleware = webServiceProvisioning.addWebServiceProvisionMiddleware;
